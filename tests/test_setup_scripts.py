...
class SetupScriptTests(unittest.TestCase):
    def test_workspace_setup_keeps_agent_sample_opt_in(self) -> None:
        ...
        self.assertIn("RUN_AGENT=1 requires .venv", script)
        self.assertIn("set RUN_AGENT=1 to run the optional sample", script)

    def test_workspace_setup_does_not_require_venv_by_default(self) -> None:
        ...
        self.assertIn("set RUN_AGENT=1 to run the optional sample", result.stdout)
